...
__kernel void BlackScholes(
    __global float * restrict d_Call, //Call option price
    __global float * restrict d_Put,  //Put option price
    __global float * restrict d_S,    //Current stock price
    __global float * restrict d_X,    //Option strike price
    __global float * restrict d_T,    //Option years
    float R,                //Riskless rate of return
    float V,                //Stock volatility
    unsigned int optN
){
